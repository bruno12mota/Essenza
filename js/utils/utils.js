...
$.fn.addRoundCorners = function(value){
...
$.fn.setTransformOrigin = function(val1, val2){
    $(this).css({    
...
$.fn.setIETransform = function(transform){
    var M11 = 1;
    var M12 = 0;
    var M21 = 0;
    var M22 = 1;
...
$.fn.processColorAndPattern = function(color, alpha, pattern){
    var object = $(this);
    //  color attributes
    if(alpha != "0" && alpha != 0){
...
$.fn.addEaseAll = function(time, type, properties){
...
$.fn.resizeAndCenter = function(w, h, ow, oh, sizing){
...
$.fn.processFont = function(font, color, size) {
	$(this).css({
		"font-family" : font,
		"color" : color,
		"font-size" : size + "px"
