...
function essenza_scripts() {
	...
	wp_register_script( 'essenza-js', get_template_directory_uri() . '/js/Essenza.js');
	wp_register_script( 'require-js', get_template_directory_uri() . '/js/other/require-jquery.js', array( 'essenza-js' ) );
