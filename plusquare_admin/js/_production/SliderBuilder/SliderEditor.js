	...
	SliderEditor.prototype = {
		...
		addElementToList: function(element){
			if(this.$elementsList.hasClass("ready"))
 				this.$elementsList.trigger("addItem", [$('<span class="image" style="width: 13px; background-image: url('+builderPathGlobal+'/UI_Elements/slider_builder/'+element.type+'_element.png);"></span><p class="title">'+(element.type == "image" ? element.type+' Element' : '&#34;'+element.$content.text()+'&#34; '+element.type+' Element')+'</p><a href="#" data-event="animation" onclick="return false;">Edit animation</a><a href="#" data-event="properties" onclick="return false;">Edit properties</a>'), this.slides[this.currentSlide].elements.length - element.depth - 1]);
 			else
		...
		backgroundTypeChanged: function(){
			...
			console.log("background type change");
			...
			//Color type
				...
				this.$slidesList.trigger("changeImage", [this.currentSlide, builderPathGlobal+'/UI_Elements/slider_builder/colored_slide.png']);
			}
			...
			//Video type
				...
				this.$slidesList.trigger("changeImage", [this.currentSlide, builderPathGlobal+'/UI_Elements/slider_builder/video_slide.png']);
			}
		},
		...
		backgroundChanged: function(){
			...
			if(attachmentId != "" && attachmentId != null && attachmentId != "undefined"){
				...
				this.$slidesList.trigger("changeImage", [this.currentSlide, builderPathGlobal+'/UI_Elements/slider_builder/no_slide.png']);
	    ...
	    addSlideToList: function(){
	    	var $toAdd = $('<span class="image" style="background-size:36px 24px; width: 36px; background-image: url('+builderPathGlobal+'/UI_Elements/slider_builder/no_slide.png);"></span><p class="title">Slide '+this.slides.length+'</p><a href="#" data-event="properties" onclick="return false;">Edit properties</a>');
	                    ...
	                    $.proxy(function(slideIndex, slideDom){
	                        ...
	                        this.slides.push(slide);
	                       	...
	                       	if(backgroundObj.type == "image"){
								...
								this.$slidesList.trigger("changeImage", [slideIndex, builderPathGlobal+'/UI_Elements/slider_builder/video_slide.png']);
