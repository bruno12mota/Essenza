...
define(["jquery",   "ui-elements", 
	...
	CustomGridListing.prototype = {
		...
		loadWorks: function(){
			...
			this.$holder.html('<p>Loading grid <img src="'+template_directory+'/plusquare_admin/UI_Elements/loading.gif" /></p>');
			jQuery.post(
				adminAjax,
				{
		...
		itemStartDrag: function(){
			...
			//console.log(this.itemsPerRow+" items per row");
			
			//get item height
			this.itemsHeight = this.items[0].$item.outerHeight();
			//console.log(this.itemsHeight+" items height");
