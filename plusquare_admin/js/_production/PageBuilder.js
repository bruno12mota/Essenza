define(["jquery", 
    ...
    PageBuilder.prototype = {
        ...
        build: function(){
            ...
            processIcon($addPageBreakButton, builderPath+"images/MainMenu/add_icon.png");
                        ...
                        if(matched[rowId] == "<!--nextpage-->"){
                            ...
                            if(matchedColumns != null){
                                ...
                                for(var columnId = 0; columnId < matchedColumns.length ; columnId ++){
                                    ...
                                    console.log("----------------content: "+columnContent);
                                    ...
                                    //console.log(regexComponentInitialStr);
                                    do{
                                    	 ...
                                    	 if(matchedComponentInitial != null){
                                            ...
                                            console.log("----------------shortcode: "+shortcodeStr);
                                    		...
                                    		if(matchedComponent != null){
                                                ...
                                                console.log("--------------------------------shortcode component: "+matchedComponent);
                                    			
                                    			//Shift columnContent
                                    			columnContent = columnContent.substring(matchedComponent.length);
                                    			//console.log("Rest: "+columnContent);
    	                                        ...
    	                                        function parseModule(obj){
    	                                        	if(obj.associate != "content"){
    	                                        		console.log(obj.associate);
    													var regexParStr = "\\s"+obj.associate+'="[\\s\\S]*?"';
    													var regexPar = new RegExp(regexParStr, "i");
    													console.log(matchedIP);
    													...
    													if(matchedPar != null){
    														...
    														if(matchedPar != null){
    											    			...
    											    			console.log(obj.associate+": "+value);
