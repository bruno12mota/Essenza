...
var Placeholder = Module.extend({
    ...
    updateSizeText: function(){
        ...
        if(this.size==12)
            this.$plusButton.css("background-image", "url("+builderPath+"images/Blocks/increase_width_disabled.png)")
        else
            this.$plusButton.css("background-image", "url("+builderPath+"images/Blocks/increase_width_enabled.png)")
            
        if(this.size==2)
            this.$minusButton.css("background-image", "url("+builderPath+"images/Blocks/decrease_width_disabled.png)")
        else
            this.$minusButton.css("background-image", "url("+builderPath+"images/Blocks/decrease_width_enabled.png)")
