define(["jquery", "ui-elements"], function($) {
	...
	var Lightbox = function(title, builderPath, saveFunction, width, exit_text, submit_text){
		...
		if(submit_text == undefined)
			submit_text = 'Submit <img class="arrow-icon" src="'+builderPath+'images/arrow.png"/>'
		if(width == undefined)
			width = 900;
	...
	Lightbox.prototype = {
		build: function(){
	        ...
	        this.$exitButton = $('<a href="#"></a>').css({
	            "width":"9px",
	            "height":"9px",
	            "background-image":"url("+this.builderPath+"images/lightbox_close.png)",
	            "position":"relative",
	            "float":"right",
	            "left": "-10px",
	            "top":"6px"
	        ...
	        this.$loadingOptions = $('<div>Loading Options</div>').css({
	            ...
	            "display":"block",
	            "padding-left": "30px",
	            "background-image":"url("+this.builderPath+"images/loading.gif)",
