...
function plusquare_template_customizer_header(){ 
	...
	echo '<link href="'.get_template_directory_uri().'/plusquare_admin/config-backend/css/fonts/stylesheet.css" rel="stylesheet" type="text/css" />';
	echo '<link href="'.get_template_directory_uri().'/plusquare_admin/config-backend/css/tc_styles.css" rel="stylesheet" type="text/css" />';
	echo '<link href="'.get_template_directory_uri().'/plusquare_admin/config-backend/css/meta_options.css" rel="stylesheet" type="text/css" />';
	
	?>
	<script data-main="<?php echo get_template_directory_uri(); ?>/plusquare_admin/config-backend/js/MetaBox" src="<?php echo get_template_directory_uri(); ?>/plusquare_admin/config-backend/js/require-jquery.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/plusquare_admin/config-backend/js/TemplateCustomizer.js"></script>
    <?php
}
...
function plusquare_template_customizer_init(){
    ...
    <div id="saving_cover_tc" class="saving_cover" style="display: none;">
    	<div>
    		<p>Saving options <img src="<?php echo get_template_directory_uri(); ?>/plusquare_admin/images/loading.gif" /></p>
    	</div>
    </div>
    <script>
