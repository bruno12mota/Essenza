...
//Pages
$esza_locations = get_nav_menu_locations();

$esza_pages_options = array();
$esza_pages_values = array();
if (isset($esza_locations['primary_nav'])) {
    $esza_menu_id = $esza_locations['primary_nav'];
	$items = wp_get_nav_menu_items( $esza_menu_id );

	//array_push ($esza_pages_options, "Index (blogroll)");
	//array_push ($esza_pages_values, " ");

	foreach ( (array) $items as $key => $menu_item ) {
	    $title = $menu_item->title;
	    $id = $menu_item->object_id ;
		array_push ($esza_pages_options, $title);
		array_push ($esza_pages_values, $id);
	}
}
...
$plusquare_template_options = array(
    ...
    array("name" => "General Settings",
          "icon" => get_template_directory_uri()."/plusquare_admin/images/icon1.png",
          "tabs" => array(
			...
			array(
				...
				"options" => array(
					array(
						...
						"id" => "page_on_front",
						"type" => "combobox",
						"options" => $esza_pages_options,
						"values" => $esza_pages_values,
						"help" => "The page you want to be your index page",
						"info" => "The pages and posts that appear here are the ones set in your main menu. So if you want a slider for example to be your homepage, make sure you add that slider post to the menu (not the slider page link, but the actual slider post) then the option will appear here."
					)
				)
			),
    ...
    array("name" => "Portfolio",
          "icon" => get_template_directory_uri()."/plusquare_admin/images/icon3.png",
          "tabs" => array(
			...
			array(
				...
				"options" => array(
					...
					array(
						...
						"type" => "tabs_unbinded",
						"id" => "formats_tabs",
						"options" => array("H1", "H2", "H3", "H4", "H5", "H6", "P", "Menu", "Footer", "Quote", "Block Quote", "Twitter Quote", "Blog", "Mosaic Blog", "Portfolio", "Lightbox", "Pagination"),
						"tabs" => array(
							//H1
							array(
								//Font family
							...
							array(
								...
								//Font spacing
								array(
									"label" => "Block Quote Letter Spacing",
    ...
    array("name" => "Color Settings",
          "icon" => get_template_directory_uri()."/plusquare_admin/images/icon2.png",
          "tabs" => array(
		  	//Main
			array(
				"name" => "Main Coloring Scheme",
				"options" => array(
					array(
						"label" => "Components",
						"type" => "tabs_unbinded",
						"id" => "main_coloring_tabs",
						"options" => array("Main", "Menu&Footer", "Text Styles", "Dropcaps", "Form Fields"),
						"info" => "With these options you can change all components in the template in an easy and short way. If you wish to change components more individually go to individual coloring section.",
						"alert" => "Changing some of the values here can change one or more values in the individual coloring section!",
						"tabs" => array(
							array(
								array(
									"label" => "Site Border",
							...
							array(
								array(
									"label" => "Headlines Styles Color",
									"id" => $pq_shortname."_headlines_color",
									"type" => "color_picker",
									"default" => "#ffffff",
									"alert" => "Changing this will change all the individual colors you might have set for each headline in the individual coloring section",
									"help" => "Defines the color to use for headlines h1 to h6."
								),
								array(
							...
							array(
								array(
									"label" => "Dropcaps Background Color",
									"id" => $pq_shortname."_dropcaps_background_color",
									"type" => "color_picker",
									"default" => "#ffffff",
									"alert" => "Changing these two values will change all the individual dropcaps",
									"help" => "Defines the background color to use for the dropcaps."
								),
								array(
									"label" => "Dropcaps Font Color",
									"id" => $pq_shortname."_dropcaps_font_color",
									"type" => "color_picker",
									"default" => "#333333",
									"help" => "Defines the background color to use for the dropcaps."
								)
			...
			//Individual
			array(
				"name" => "Individual Coloring",
				"options" => array(
					array(
						"label" => "Components",
						"type" => "tabs_unbinded",
						"id" => "individual_coloring_tabs",
						"info" => "Here you can change every element's coloring options",
						"alert" => "It's adviced that you change the main coloring scheme first as some options there will change the majority of options in this section!",
						"options" => array("Text Styles", "Dropcaps", "Blog", "Portfolio", "Gallery", "Music Player", "Video", "Quote", "Block Quote", "Tabs", "Alert Boxes", "Tweet Block", "Pagination", "Filter Menu", "Comments", "Lightbox", "Other"),
						"tabs" => array(
    ...
    array("name" => "Language Settings",
          "icon" => get_template_directory_uri()."/plusquare_admin/images/icon4.png",
          "tabs" => array(
